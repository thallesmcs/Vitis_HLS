; ModuleID = 'D:/Projetos_HLS/soma/soma/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"struct.ap_int<7>" = type { %"struct.ap_int_base<7, true>" }
%"struct.ap_int_base<7, true>" = type { %"struct.ssdm_int<7, true>" }
%"struct.ssdm_int<7, true>" = type { i7 }
...
define void @apatb_soma_ir(%"struct.ap_int<7>"* nocapture readonly %A, %"struct.ap_int<7>"* nocapture readonly %B, %"struct.ap_int<8>"* noalias nocapture nonnull dereferenceable(1) %C) local_unnamed_addr #0 {
entry:
  %C_copy = alloca i8, align 512
  call fastcc void @copy_in(%"struct.ap_int<8>"* nonnull %C, i8* nonnull align 512 %C_copy)
  call void @apatb_soma_hw(%"struct.ap_int<7>"* %A, %"struct.ap_int<7>"* %B, i8* %C_copy)
...
declare void @apatb_soma_hw(%"struct.ap_int<7>"*, %"struct.ap_int<7>"*, i8*)
...
declare void @soma_hw_stub(%"struct.ap_int<7>"* nocapture readonly, %"struct.ap_int<7>"* nocapture readonly, %"struct.ap_int<8>"* noalias nocapture nonnull)

define void @soma_hw_stub_wrapper(%"struct.ap_int<7>"*, %"struct.ap_int<7>"*, i8*) #4 {
entry:
  %3 = call i8* @malloc(i64 1)
  %4 = bitcast i8* %3 to %"struct.ap_int<8>"*
  call void @copy_out(%"struct.ap_int<8>"* %4, i8* %2)
  call void @soma_hw_stub(%"struct.ap_int<7>"* %0, %"struct.ap_int<7>"* %1, %"struct.ap_int<8>"* %4)
  call void @copy_in(%"struct.ap_int<8>"* %4, i8* %2)
  call void @free(i8* %3)
  ret void
}
