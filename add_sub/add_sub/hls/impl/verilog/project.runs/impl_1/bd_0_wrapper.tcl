namespace eval ::optrace {
  variable script "F:/Xilinx/projeto_hls/add_sub/add_sub/hls/impl/verilog/project.runs/impl_1/bd_0_wrapper.tcl"
...
set rc [catch {
  ...
  open_checkpoint F:/Xilinx/projeto_hls/add_sub/add_sub/hls/impl/verilog/project.runs/impl_1/bd_0_wrapper.dcp
  set_property webtalk.parent_dir F:/Xilinx/projeto_hls/add_sub/add_sub/hls/impl/verilog/project.cache/wt [current_project]
  set_property parent.project_path F:/Xilinx/projeto_hls/add_sub/add_sub/hls/impl/verilog/project.xpr [current_project]
  set_property ip_repo_paths F:/Xilinx/projeto_hls/add_sub/add_sub/hls/impl/ip [current_project]
  update_ip_catalog
  set_property ip_output_repo F:/Xilinx/projeto_hls/add_sub/add_sub/hls/impl/verilog/project.cache/ip [current_project]
