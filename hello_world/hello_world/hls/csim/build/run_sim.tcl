...
# 
# ==============================================================
set ::env(PATH) "E:/Xilinx/Vitis/2024.2/win64/tools/fpo_v7_1;$::env(Path)"
set ::env(PATH) "E:/Xilinx/Vitis/2024.2/win64/tools/fft_v9_1;$::env(Path)"
set ::env(PATH) "E:/Xilinx/Vitis/2024.2/win64/tools/fir_v7_0;$::env(Path)"
set ::env(PATH) "E:/Xilinx/Vitis/2024.2/win64/tools/dds_v6_0;$::env(Path)"
set ::env(PATH) "E:/Xilinx/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt/bin;$::env(Path)"
set_param hls.enable_hidden_option_error false
set ::env(PATH) "$::env(PATH);E:/Xilinx/Vitis/2024.2/win64/csim"
### C sim ###
