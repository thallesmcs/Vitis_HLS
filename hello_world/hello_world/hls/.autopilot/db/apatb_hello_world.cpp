...
// wrapc file define:
#define AUTOTB_TVIN_valor "../tv/cdatafile/c.hello_world.autotvin_valor.dat"
#define AUTOTB_TVOUT_valor "../tv/cdatafile/c.hello_world.autotvout_valor.dat"
#define AUTOTB_TVIN_mensagem "../tv/cdatafile/c.hello_world.autotvin_mensagem.dat"
#define AUTOTB_TVOUT_mensagem "../tv/cdatafile/c.hello_world.autotvout_mensagem.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_mensagem "../tv/rtldatafile/rtl.hello_world.autotvout_mensagem.dat"
...
extern "C"
void hello_world_hw_stub_wrapper(hls::sim::Byte<4>, void*);

extern "C"
void apatb_hello_world_hw(hls::sim::Byte<4> __xlx_apatb_param_valor, void* __xlx_apatb_param_mensagem)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_valor),
#endif
  };
  port0.param = &__xlx_apatb_param_valor;
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_mensagem),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_mensagem),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_mensagem),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_mensagem),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_mensagem),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_mensagem),
#endif
#endif
    .hasWrite = { true },
  };
  port1.param = { __xlx_apatb_param_mensagem };
  port1.mname = { "mensagem" };
  port1.nbytes = { 100 };
  ...
  try {
    ...
    hello_world_hw_stub_wrapper(__xlx_apatb_param_valor, __xlx_apatb_param_mensagem);
